  ...
  Widget build(BuildContext context) {
    ...
    return EasyLocalizationProvider(
        ...
        body: Stack(
          ...
          overlayShadow: false,
          images: [
            AssetImage('assets/img/ps4.jpg'),
            AssetImage("assets/img/xboxX.jpg"),
                          ...
                          Container(
                            ...
                            child: Column(
                              ...
                              children: <Widget>[
                                ...
                                Center(
                                  /// Animation text GameTrop shop accept from splashscreen layout (Click to open code)
                                  child: Hero(
                                    tag: "GameTrop",
                                    child: Text( "GameTrop",
                                ...
                                /// Padding Text "Get best product in GameTrop shop" (Click to open code)
                                Padding(
                                    padding: EdgeInsets.only(
                                        left: 160.0,
                                        right: 160.0,
                                ...
                                Text("All the gaming equipment you'll need",
                                  style: TextStyle(
                                      color: Colors.white,
                                      fontSize: 17.0,
                                ...
                                Padding(padding: EdgeInsets.only(top: 250.0, bottom: 220)),
                              ],
                            ),
                          ),
                          Column(
